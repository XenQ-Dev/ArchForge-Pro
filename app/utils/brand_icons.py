"""Render Apple / Google brand logos as QPixmaps via QtSvg (no external files)."""
from __future__ import annotations
from PyQt6.QtGui import QPixmap, QPainter, QColor
from PyQt6.QtCore import Qt, QByteArray
from PyQt6.QtSvg import QSvgRenderer

# Apple logo — single path, recolourable
_APPLE = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
<path fill="{c}" d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0
...
-.57 1.5-1.31 2.99-2.53 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58
-2.34 4.5-3.74 4.25z"/></svg>"""

# Google "G" — full colour brand mark
_GOOGLE = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
def apple_icon(size: int = 18, colour: str = "#ffffff") -> QPixmap:
    return _render(_APPLE.format(c=colour), size)


def google_icon(size: int = 18) -> QPixmap:
    return _render(_GOOGLE, size)
